"""
Django settings for myfirstwebproject project.
...
SECRET_KEY = 'django-insecure-sm8lr(2n@cytl3-j55cc24cuv&e=)r(tnf(wkx_)orvxvu$lxi'
...
WSGI_APPLICATION = 'myfirstwebproject.wsgi.application'
